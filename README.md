...
[![Policies](https://img.shields.io/badge/السياسات-25-1B3A5C?style=flat-square)]()
...
مستودع CyberPolicy-KW يحتوي على **25 سياسة وإجراء ومعيار** لأمن المعلومات، جاهزة للتعديل والتطبيق، ثنائية اللغة (عربي + إنجليزي)، متوافقة مع المعايير المحلية والدولية. يتضمن المستودع **مولّد مستندات** يُنتج السياسات بصيغة DOC و PDF، و**أداة متابعة الالتزام المستمر** لتتبع تقدم المؤسسة.
...
### السياسات والإجراءات
- **25 سياسة وإجراء ومعيار** تغطي جميع مجالات أمن المعلومات
...
| # | السياسة | النوع |
|---|---------|-------|
| 06 | سياسة أمن الموارد البشرية | سياسة |
